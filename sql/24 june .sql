...
insert into products values(1, 'Laptop', 50000, 25, 'Mumbai');
insert into products values(2, 'Smartphone', 30000, 50, 'Delhi');
insert into products values(3,'Headphones', 2500, 100, 'Mumbai');
insert into products values(4,'Tablet', 20000, 30, 'Delhi');
insert into products values(5,'Smartwatch', 15000, 40, 'Mumbai');
...
insert into orders values(10001,102,3,2500);
insert into orders values(10002,104,2,30000);
insert into orders values(10003,105,5,1500);
insert into orders values(10004,101,1,50000);


#inserting values into payments table
insert into payment values(1,10001,2500,'upi','completed');
insert into payment values(2,10002,30000,'credit','completed');
insert into payment values(3,10003,1500,'debit','in process');
